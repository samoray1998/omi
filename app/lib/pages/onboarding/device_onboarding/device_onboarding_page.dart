...
class _DeviceOnboardingPageState extends State<DeviceOnboardingPage> with SingleTickerProviderStateMixin {
  ...
  final List<Map<String, String>> _slideContent = [
    {
      'title': 'Charging Your Taya',
      'subtitle': 'Place your Taya on the charging dock. An orange light indicates that it\'s charging.',
      'buttonText': 'Got it'
    },
    {
      'title': 'Device Disconnected',
      'subtitle': 'When disconnected, your Taya will show a red light to indicate offline status.',
      'buttonText': 'Understood'
    },
    {
      'title': 'Device Connected',
      'subtitle': 'A blue light indicates that your Taya is connected and capturing conversations.',
      'buttonText': 'Perfect'
    },
    {
      'title': 'Ask Questions',
      'subtitle': 'Long press Taya and speak out to ask questions. Taya will respond through notifications.',
      'buttonText': 'Cool'
    },
    {
      'title': 'Power Control',
      'subtitle': 'Short press the button to turn your Taya device on or off as needed.',
      'buttonText': 'Let\'s Go!'
    },
  ];
