  ...
  void initState() {
    ...
    final stepMap = {
      'no_usb': FirmwareUpdateStep(
        title: 'No USB',
        description:
            "Disconnect your Taya device from any USB connection. USB connection during updates may damage your device.",
        icon: Icons.usb_off,
      ),
      'battery': FirmwareUpdateStep(
        title: 'Battery > 15%',
        description: "Ensure your Taya device has at least 15% battery remaining for a safe update.",
